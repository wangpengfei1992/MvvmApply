...
abstract class BaseDao<T> {
    ...
    fun deleteByParams(params: String, value: String): Int {
        var name = tableName
        val query = SimpleSQLiteQuery("delete from $name where $params='${value}'")
        LogUtil.d(TAG, "deleteByParams: ${"delete from $name where $params='${value}'"}")
    ...
    val tableName: String
        get() {
            ...
            LogUtil.d(TAG, "getTableName: -->$tableName")
            return tableName
        }
